...
const Upi = memo(({
  ...
  const upiBenf = useMemo(()=>getPaytmBenf(benifeciaries), [benifeciaries]);
  ...
  useEffect(()=>{
    setSelectedPaymentChannel(getPaymentChannelState(paymentChannels, upiBenf));
  }, [upiBenf]);
  // lifeCycle ends here
  ...
  return (
    <>
      ...
      <div className="mb-5">
        <label className="font-weight-bold">Add New UPI Beneficiary</label>
...
export default connect(mapStateToProps, {showToast})(Upi);
